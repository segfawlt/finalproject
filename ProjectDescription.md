...
- [open-issues.md](./open-issues.md) — Resolved design decisions and still-open questions
- [openspec/specs/](./openspec/specs/) — Formal capability specs (shared-types, tool-schemas, etc.)
- [openspec/changes/archive/](./openspec/changes/archive/) — Archived change proposals

  ...
  return (
    <div className="p-4 space-y-3">
      <header>
        ...
        <p className="text-shell-text-muted text-xs">Per-server template library (coming soon).</p>
      </header>
      <div className="rounded-md border border-dashed border-shell-border p-4 text-center">
        <p className="text-shell-text-muted text-sm">The in-app browser lands in a later phase.</p>
        <Link

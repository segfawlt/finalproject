...
| **Scheduler**     | Supporting (internal, time-triggered) | Periodically initiates drift detection from inside the platform's own backend. It represents the passage of time rather than a human user or an external system.  |
...
| **Primary actor**    | Administrator                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Secondary actors** | Discord API, LLM Provider (policy validation against server rules)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
of Conduct [32], the relevant professional standard for this work.

### 3.6.1 Legal issues

**Data protection (UK GDPR / GDPR [31]).** The system processes personal data about
...
The relevant principles [31] include _lawfulness, fairness and transparency_, _data
...
Conduct [32]: the public interest, professional competence and integrity, duty to
